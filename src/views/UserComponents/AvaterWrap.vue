        ...
        <div class="card_body">
            <ul>
                    ...
                    <div class="title_profile">
                        <span class="name">
                            <div style="display: flex; align-items: center;">
                                ...
                                <el-tag style="margin-left: 20px; font-size: 20px;" v-if="openAlexAccount == 1"
                ...
                <li class="right-btn-wrap" style="float: right; vertical-align: middle;" v-if="personAccount == 1">
                    <el-button class="right-btn" type="primary" size="large" plain @click="changeDialogShow = true"
                        :icon="Edit">编辑
                    </el-button>
                </li>
