    ...
    <div class="result-item__content">
      ...
      <div class="card-footer clearfix">
        ...
        <div class="card-footer-right">
          ...
          <!-- openAlex 将venue所有的works 列为一个 list 网页 -->
          <ul class="rlist--inline dot-separator" style="float: right;"
            v-if="item.works_api_url">
            <li v-if="item.works_api_url">
              <div class="card-tool-btn all-works-btn" @click="jumpToAllWorksOfVenue(item.works_api_url)">
                <i class="iconfont icon-list" style="font-size: 0.9rem;"></i>
                <span class="card-btn-hint">
                  <span class="card-btn-hint-arrow"></span>
                  Get All Works of the Venue
                </span>
              </div>
            </li>
          </ul>
